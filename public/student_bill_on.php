...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("student_bill_on", $splitAccessPages, TRUE)) {
...
<div class="container">
    ...
    $bill->saveClassBillItemSuccessBanner();
                                            ...
                                            <tr>
                                                <td style="text-align: center; background-color: #F5F5F5; font-weight: 600; padding: 10px;" colspan="10">
                                                    ...
                                                    <select name="selected_class_name" class="select">
                                                        ...
                                                        <?php
                                                       while ($value_sec = mysqli_fetch_array($getClasses_sec)) {
                                                            ?>
                                                            <option value="<?php echo htmlentities($value_sec["class_name"]); ?>"><?php echo htmlentities($value_sec["class_name"]); ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
...
//                                        $get_academic_term = $getAcademicTerm["academic_year"] . "/" . $getAcademicTerm["term"];
                    ...
                    <a href="print_class_bills.php" class="btn btn-primary" target="_blank">Generate Student Bills</a>
                    <legend class="legend"></legend>
                </form>
                <?php
            }
