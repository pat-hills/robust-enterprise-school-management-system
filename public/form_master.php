...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("form_master", $splitAccessPages, TRUE)) {
...
<div class="container">
    ...
    if (isset($_POST["submit"])) {
        ...
        $validator->addValidation("class_name", "dontselect=Select Class", "Please, select a class name.");
        $validator->addValidation("house_head", "dontselect=Select Class Teacher", "Please, select Class Teacher.");

        if ($validator->ValidateForm()) {
            $formMaster->insertFormMaster();
        } else {
        ...
        <div class="row">
            <div class="span12">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend style="color: #4F1ACB;"><strong>Class Teacher Assignment</strong></legend>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="house_head">
                                    <option value="Select Class Teacher">--Select Class Teacher--</option>
                                    <?php
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <a href="form_master.php" class="btn btn-danger">Clear</a>
                            </div>
                        </div>
                    </fieldset>
