...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("ledger", $splitAccessPages, TRUE)) {
            ...
            if (TRUE == $show_form) {
                ...
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        $get_class_name_by_id_an_current_term = $classMembership->getClassNameByStudentIdAndCurrentTerm($pupil_id, $get_academic_term);
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="controls">
                                                                        <input class="span2" type="text" name="class" autocomplete="off" disabled 
                                                                               value="<?php
                                                                               if (isset($get_class_name_by_id_an_current_term["class_name"])) {
                                                                                echo   $get_class_name_by_id_an_current_term["class_name"];
                                                                               }
                                                                               ?>">
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="controls">
                                                                        <input class="span2" type="text" name="boarding_status" autocomplete="off" disabled
                                                                               value="<?php
                                                                              if (isset($get_class_name_by_id_an_current_term["boarding_status"])) {
                                                                                echo   $get_class_name_by_id_an_current_term["boarding_status"];
                                                                               }
                                                                               ?>">
                                                                    </div>
                                                                </td>
...
//                                                                        
//                                                                        
//                                                                        $overall_debit = ($getFeesPayable["allFeesPayable"] + $singleBillAmount + $getPTAAll["ptaFeesAll"]) - ($credit_gotten);
//                                                                        
//                                                                      //  
//                                                                        
//                                                                        
//                                                                       echo $getBalance = number_format(($overall_debit ), 2, ".", ",");
