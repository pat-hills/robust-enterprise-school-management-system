...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("clerk", $splitAccessPages, TRUE)) {
    ...
    <div class="metro panorama" style="padding-bottom: 249px;">
        <div class="panorama-sections">
            <div class="panorama-section tile-span-4">
                ...
                <a class="tile wide imagetext wideimage bg-color-green" href="print_fees_collected_today.php" target="_blank">
                    <img src="./img/bkg-win8.jpg" alt=""/>
                    <div class="textover-wrapper transparent">
                        <div class="text2">PRINT FEES COLLECTED TODAY</div>
                    </div>
                </a>
            </div>
        </div>
