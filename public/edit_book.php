...
if(getURL()){
     ...
     $book_set = $library ->check_existing_book($url_hash);
        ...
        <div class="row">
            <div class="span12">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend style="color: #4F1ACB;"><strong>Edit Book Details</strong></legend>
...
<!--                                    <input class="span2" type="hidden" name="school_number" value="<?php //echo $institutionSet["school_number"]; ?>">-->
                                    <input class="span2" width="" type="hidden" required="true" name="book_id" value="<?php echo $book_set['id_of_book']; ?>">
...
<!--                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" required="true" type="text" name="book_name" 
                                                   value="<?php
                                                   echo $book_set['name_of_book'];
                                                   ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" type="text"   name="author"   value="<?php
                                            echo  $book_set["author_of_book"];
                                            ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" required="true" type="text" name="pages" autocomplete="off" value="<?php
                                          echo   $book_set['total_pages_of_book'];
                                            ?>" />
                                        </div>
                                    </div>
                           ...
                           <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="subjectt" required="true">
                                             
                                                <option value="<?php  echo $book_set["subject_of_book"]; ?>"> <?php  echo $book_set["subject_of_book"]; ?>   </option>
                                        ...
                                        <div class="controls">
                                            <label class="radio inline">
                                                <input type="radio" required="true" name="category" id="elective" value="Elective"
                                                       <?php 
                                                          if($book_set['category_of_book']=="Elective")
                                                              echo "checked";
                                            ...
                                            <label class="radio inline">
                                                <input type="radio" required="true" name="category" id="core" value="Core"
                                                        <?php 
                                                          if($book_set['category_of_book']=="Core")
                                                              echo "checked";
                        ...
                        <table class="table table-bordered table-condensed">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #F5F5F5; text-align: center; font-weight: 600; width: 9%;">NUM OF PAGES</td>
