...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("other_incomes", $splitAccessPages, TRUE)) {
...
<div class="container">
    <?php
    require_once '../includes/breadcrumb_for_other_incomes.php';
...
<div class="container">
    <?php
    $show_form_2 = TRUE;
    if (isset($_POST["submit"]) && !empty($_POST["description"]) && !empty($_POST["amount"])) {
        $validator = new FormValidator();
