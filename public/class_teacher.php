...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("class_teacher", $splitAccessPages, TRUE)) {
                ...
                <div id="header-container">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                            <li><a href="teachers_continuous_assessment.php">Continuous Assessment</a></li>
                            <li><a href="teacher_comment.php">Class Teacher Comment</a></li>
                            <li><a href="edit_teacher_comment.php">Edit Class Teacher Comment</a></li>
    ...
    <div class="metro panorama" style="padding-bottom: 249px;">
        <div class="panorama-sections">
            <div class="panorama-section tile-span-4">
                <h2 style="padding-top: 50px; padding-bottom: 25px;">featured app</h2>
                
                <a class="tile app bg-color-pink" href="teachers_continuous_assessment.php">
                    <div class="image-wrapper">
                        <span class="icon icon-globe-2"></span>
                    </div>
                    <div class="app-label">Continuous Assessment</div>
                </a>
                
                <a class="tile app bg-color-purple" href="teacher_comment.php">
                    <div class="image-wrapper">
                        <span class="icon icon-air"></span>
                    </div>
                    <div class="app-label">Class Teacher Comment</div>
                </a>
                
                <a class="tile app bg-color-orange" href="edit_teacher_comment.php">
                    <div class="image-wrapper">
                        <span class="icon icon-dropbox"></span>
                    </div>
                    <div class="app-label">Edit Class Teacher Comment</div>
                </a>
                
<!--                <a class="tile app bg-color-gray" href="attendance.php">
                    <div class="image-wrapper">
                        <span class="icon icon-beta"></span>
                    </div>
                    <div class="app-label">Check Attendance</div>
                </a>-->
            </div>
        </div>
