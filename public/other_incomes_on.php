...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("other_incomes_on", $splitAccessPages, TRUE)) {
...
<div class="container">
    ...
    $bill->otherIncomesSuccessBanner();

    $show_form = TRUE;
    if (isset($_POST["submit_entries"])) {
        $validator = new FormValidator();
        $validator->addValidation("entries", "req", "Please, fill in the <strong>Total Entries</strong> before you click the <strong>CREATE ENTRY BOXES</strong> button!");
        ...
        <div class="row">
            <div class="span12">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend style="color: #4F1ACB;"><strong>Other Income Entries</strong></legend>
                        <div class="wrapper">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="other_incomes.php" class="btn large btn-danger">Clear</a>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <div class="center-table">
                        <div class="row">
                            <div class="span8">
                                ...
                                <a href="other_incomes.php" class="btn btn-danger" style="margin-left: 20px;">Cancel All</a>
                            </div>
                        </div>
                    </div>
                </form>
