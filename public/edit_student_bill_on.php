...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("edit_student_bill_on", $splitAccessPages, TRUE)) {
...
<div class="container">
    ...
    $bill->editClassBillItemSuccessBanner();
...
//    $academic_terms = $academicTerm->getAcademicTerm($getAcademicYear["academic_year"]);
    ...
    <div class="row">
        <div class="span12">
            ...
            <form class="form-horizontal" method="post" style="padding-top: 15px;">
                <fieldset>
                    <?php
                    $show_form_2 = TRUE;
...
//                        $_SESSION["selected_term"] = $selected_term;
...
//                                        $get_academic_term = $getAcademicTerm["academic_year"] . "/" . $getAcademicTerm["term"];
                ...
                <a href="print_student_bills.php" class="btn btn-primary" target="_blank">Generate Student Bills</a>
                <legend class="legend"></legend>
            </form>
        </div>
    </div>
