...
for ($i = 0; $i < count($splitAccessPages); $i++) {
    if (!in_array("class_teacher_members", $splitAccessPages, TRUE)) {
        redirect_to("logout_access.php");
    }
}

if (!isset($_SESSION["class_teacher_members"])) {
    redirect_to("edit_teacher_comment.php");
}
?>
...
//    $getClassMember = $classMembership->checkCommentByClassName($_SESSION["class_teacher_members"]);
    $getClassMember = $classMembership->editHeadRemarkByClassName($_SESSION["class_teacher_members"]);
